      ...
      <div id='container' className='container'>
        {/* navigation menu on the left */}
          ...
          <div className="social">
            <a href="https://linkedin.com/in/bruceisyoung" target="_blank" className="linkedin"><i className="fa fa-linkedin-square"></i></a>
            <a href="https://github.com/bruceisyoung" target="_blank" className="github"><i className="fa fa-github"></i></a>
            <a href="https://facebook.com/bruceisyoung" target="_blank" className="facebook"><i className="fa fa-facebook-square"></i></a>
          </div>
      	</aside>
